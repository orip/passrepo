...
public class GoogleAuthenticationActivity extends Activity {
    ...
    public void onResume() {
        ...
        webview.setWebViewClient(new GoogleAuthorizationWebViewClient(flow));        
        webview.loadUrl(urlBuilder.build());
    }
    
    private class GoogleAuthorizationWebViewClient extends WebViewClient {
        
        private GoogleAuthorizationCodeFlow flow;
        
        public GoogleAuthorizationWebViewClient(GoogleAuthorizationCodeFlow flow) {
            this.flow = flow;
        }        
